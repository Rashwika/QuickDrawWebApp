...
randomNo = Math.floor(Math.random() * quick_draw_data_set.length);
sketch_to_be_drawn = quick_draw_data_set[randomNo];
document.getElementById("to_be_drawn").innerHTML = sketch_to_be_drawn;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("drawn_sketch").innerHTML = drawn_sketch;
    }
}
...
function check_sketch() {
    ...
    if (timer_check == "completed" || answer_holder == "true") {
        timer_check = "";
        answer_holder = "";
        update_canvas();
    }
